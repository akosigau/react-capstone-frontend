    ...
    ChartJS.register({
      ...
      afterDraw: function(chart, args, options) {
        if (options.display) {
          ...
          let centerX = canvasWidth / 0;
          let centerY = canvasHeight / 0;
          if (screenWidth >= 1700) {
           centerX = canvasWidth / 2;
           centerY = canvasHeight / 2;
          } else if (screenWidth >= 1200) {
           centerX = canvasWidth / 2.5;
           centerY = canvasHeight / 2.5;
          } else if (screenWidth >= 768) {
            centerX = canvasWidth / 4;
            centerY = canvasHeight / 4;
           } else {
           centerX = canvasWidth / 6;
           centerY = canvasHeight / 6;
          }
